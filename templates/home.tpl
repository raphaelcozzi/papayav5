    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="home">
                        <img src="assets/layouts/layout4/img/logo-light.png" alt="logo" class="logo-default" style="margin-top:0px;"  /> </a>
               ...
               <!-- BEGIN PAGE TOP -->
                <div class="page-top">
                    ...
                    <!-- END TOP NAVIGATION MENU -->
                     ...
                     <!--<div style="float:left; margin-top: 0px;"><h2>DMS WAREHOUSE SYSTEM</h2></div>-->           
